...
public class Model {
	...
	@Column(name = "model_id", type = ClassUtils.TYPE_INTEGER, nullable = false, comment = "主键")
	private Integer id;

	@Column(name = "model_name", nullable = false, comment = "模型名称")
	private String name;

	@Column(name = "model_status", type = ClassUtils.TYPE_INTEGER, nullable = false, length = 2, comment = "状态,对应枚举值"
	...
	@Column(name = "model_table", nullable = false, comment = "数据库表名")
	private String table;

	@Column(name = "model_pk", nullable = false, comment = "主键名称")
	private String pk;

	@Column(name = "model_auto_increment", type = ClassUtils.TYPE_BOOLEAN, nullable = false, defaultValue = "true", comment = "模型数据库主键是否整型自增长1-是 0-否,如果否则为UUID")
